...
def main():
    ...
    raw_dir = "../idk/original gothic files/small gothic extra oops"

    num_chars = 5 #for mincho kanji templates, 64, for kana, 35. for small kanji, 925

    list_of_files = os.listdir(raw_dir) 
    raw_kanji = u"勺 匁 脹 銑 錘 "
