...
def make_templates(im, kanji):
    ...
    width = 39 #125 for mincho kanji, 150 for gothic, 200 for kana, 39 for small kanji
    height = 34 #145 for kanji, 150 for gothic, 150 for kana, 34 for small kanji OR 39?? swear the first time i did this it was much harder.
    origin = 0
    ...
    for i in range(1, len(kanji)+1):
        ...
        if i % 25 == 0 and i != 0: #8 for mincho kanji, 6 for gothic, 5 for kana, 25 for small kanji
            #go to the next line
...
def main():
    ...
    sm_kanji_box = (142, 147, 1117, 1414) # last number used to be 1414, idk
